...
const TRADUCTIONS = {
  ...
  "jeux.tab.quiz":   { fr: "❓ Quiz du jour", en: "❓ Daily quiz" },
  "jeux.tab.vf":     { fr: "✅ Vrai ou Faux", en: "✅ True or False" },
  "jeux.points":     { fr: "points aujourd'hui", en: "points today" },
  "jeux.streak":     { fr: "🔥 Jours de suite", en: "🔥 Day streak" },
  "jeux.record":     { fr: "⭐ Record points", en: "⭐ Points record" },
  "jeux.share":      { fr: "📋 Partager mon score", en: "📋 Share my score" },
  "jeux.next":       { fr: "Prochain quiz dans", en: "Next quiz in" },
  "jeux.next.vf":    { fr: "Nouveau défi demain", en: "New challenge tomorrow" },
  "jeux.vf.total":   { fr: "bonnes réponses", en: "correct answers" },
